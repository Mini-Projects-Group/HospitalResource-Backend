...
const handleDisconnect = () => {
  connection = mysql.createConnection({
    ...
    port: process.env.MYSQL_PORT,
        ...
        // Credenetial table
        const credentials_sql = "CREATE TABLE IF NOT EXISTS credential(credential_id INT PRIMARY KEY AUTO_INCREMENT,email_id VARCHAR(50) NOT NULL UNIQUE,password VARCHAR(100) NOT NULL,address VARCHAR(255) NOT NULL,contact_no BIGINT NOT NULL,type_id INT, FOREIGN KEY(type_id) REFERENCES type(type_id) ON DELETE CASCADE ON UPDATE CASCADE);";
        ...
        // ITEM NAME
        const item_name_sql = "CREATE TABLE IF NOT EXISTS itemname(item_name_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,item_name VARCHAR(255));"
